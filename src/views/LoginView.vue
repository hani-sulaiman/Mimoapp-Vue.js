    ...
    <div class="container">
        <form class="login-form" @submit.prevent="login">
            ...
            <div class="input-group">
                ...
                <input type="email" id="email" v-model="loginData.email" placeholder="Enter your email" required>
            </div>
            <div class="input-group">
            ...
            <LoadingButton :isLoading="loading" :ButtonName="buttonName" />
    ...
    data() {
        ...
        async login() {
            try {
                ...
                const response = await axios.post( `${baseURL}/login`, this.loginData, {
                    headers: {
